...
namespace Financial.Amount_specs
{
    public class Supports_type_conversion
    {
        ...
        public void from_empty_string()
        {
            using (TestCultures.En_GB.Scoped())
            {
                Converting.To<Amount>().From(string.Empty).Should().Be(Amount.Zero);
            }
        }
        ...
        public void from_string()
        {
            using (TestCultures.En_GB.Scoped())
            {
                Converting.To<Amount>().From("SvoValue").Should().Be(Svo.Amount);
            }
        }
        ...
        public void to_string()
        {
            using (TestCultures.En_GB.Scoped())
            {
                Converting.Value(Svo.Amount).ToString().Should().Be("SvoValue");
            }
        }
