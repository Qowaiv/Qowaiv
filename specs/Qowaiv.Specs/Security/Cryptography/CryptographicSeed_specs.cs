...
{
    [Test]
    public void from_null_string_represents_Empty() => CryptographicSeed.Parse(null).Should().Be(CryptographicSeed.Empty);

    [Test]
    public void from_empty_string_represents_Empty() => CryptographicSeed.Parse(string.Empty).Should().Be(CryptographicSeed.Empty);
