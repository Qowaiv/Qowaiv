...
public class CountryTest
{
    ...
    [Test]
    public void Equals_TestStructTestStruct_IsTrue() => CountryTest.TestStruct.Equals(CountryTest.TestStruct).Should().BeTrue();

    [Test]
    public void Equals_TestStructEmpty_IsFalse() => CountryTest.TestStruct.Equals(Country.Empty).Should().BeFalse();

    [Test]
    public void Equals_EmptyTestStruct_IsFalse() => Country.Empty.Equals(CountryTest.TestStruct).Should().BeFalse();

    [Test]
    public void Equals_TestStructObjectTestStruct_IsTrue() => CountryTest.TestStruct.Equals((object)CountryTest.TestStruct).Should().BeTrue();

    [Test]
    public void Equals_TestStructNull_IsFalse() => CountryTest.TestStruct.Equals(Nil.Object).Should().BeFalse();

    [Test]
    public void Equals_TestStructObject_IsFalse() => CountryTest.TestStruct.Equals(new object()).Should().BeFalse();
