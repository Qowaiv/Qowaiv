...
namespace Qowaiv.CodeGenerator.CodeDom.Razor
{
    ...
    public abstract class RazorTemplate
    {
        ...
        protected RazorTemplate()
        {
            ...
            this.Writer = new StringWriter(this.Buffer, CultureInfo.InvariantCulture);
        }
        ...
        /// <summary>A collection with all available tempaltes.</summary>
        ...
        {
            return Collection.RenderModel(model, postfix);
        }
        ...
        {
            return Collection.RenderSnippet(name);
        }
        ...
        public void GenerateFile(object model, DirectoryInfo dir, string path)
        {
            GenerateFile(model, new FileInfo(Path.Combine(dir.FullName, path)));
        }
        ...
        /// <summary>Represents the the template as string.</summary>
        protected virtual string DebugToString()
        {
