...
namespace Qowaiv
{
    ...
    public struct BankIdentifierCode : ISerializable, IXmlSerializable, IJsonSerializable, IFormattable, IComparable, IComparable<BankIdentifierCode>
    {
        ...
        public static readonly BankIdentifierCode Empty = new BankIdentifierCode() { m_Value = default(String) };
        ...
        /// <summary>Adds the underlying propererty of BIC to the serialization info.</summary>
        /// <param name="info">The serialization info.</param>
        /// <param name="context">The streaming context.</param>
        ...
        /// </returns>
        public int CompareTo(BankIdentifierCode other) { return (m_Value ?? String.Empty).CompareTo(other.m_Value ?? String.Empty); }
