...
namespace Qowaiv.Conversion
{
    ...
    public class BankIdentifierCodeTypeConverter : TypeConverter
    {
        #region Convert From

        /// <summary>Returns whether this converter can convert an string to
        /// a BIC, using the specified context.
        /// </summary>
        /// <param name="context">
        ...
        /// <summary>Converts a BIC to string, using the specified context and culture information.</summary>
        /// <param name="culture">
        ...
        /// </param>
        /// <returns>
        /// A string that represents the converted BIC.
        /// </returns>
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            ...
            {
                return ((BankIdentifierCode)value).ToString(culture);
            }
