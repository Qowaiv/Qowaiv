...
namespace Qowaiv.Conversion
{
    ...
    public class CurrencyTypeConverter : TypeConverter
    {
        ...
        /// a currency, using the specified context.
        /// </summary>
        /// <param name="context">
        ...
        /// <summary>Converts a string to a currency, using the specified
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            ...
            {
                return Currency.Parse(str, culture);
            }
        ...
        /// <summary>Converts a currency to string, using the specified context and culture information.</summary>
        /// <param name="culture">
        ...
        /// </param>
        /// <returns>
        /// A string that represents the converted currency.
        /// </returns>
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            ...
            {
                return ((Currency)value).ToString(culture);
            }
