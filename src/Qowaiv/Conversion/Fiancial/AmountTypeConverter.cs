...
namespace Qowaiv.Conversion.Financial
{
    ...
    public class AmountTypeConverter : TypeConverter
    {
        ...
        /// an Amount, using the specified context.
        /// </summary>
        /// <param name="context">
        ...
        /// <summary>Converts a string to an Amount, using the specified
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            ...
            {
                return Amount.Parse(str, culture);
            }
        ...
        /// <summary>Converts an Amount to string, using the specified context and culture information.</summary>
        /// <param name="culture">
        ...
        /// </param>
        /// <returns>
        /// A string that represents the converted Amount.
        /// </returns>
