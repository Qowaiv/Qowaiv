...
namespace Qowaiv.Conversion.Financial
{
    ...
    public class MoneyTypeConverter : TypeConverter
    {
        ...
        /// <summary>Converts a string to Money, using the specified
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            ...
            {
                return Money.Parse(str, culture);
            }
        ...
        /// <summary>Converts Money to string, using the specified context and culture information.</summary>
        /// <param name="culture">
        ...
        /// </param>
        /// <returns>
        /// A string that represents the converted Money.
        /// </returns>
