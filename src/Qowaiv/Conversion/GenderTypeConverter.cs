...
namespace Qowaiv.Conversion
{
    ...
    public class GenderTypeConverter : TypeConverter
    {
        ...
        /// a Gender, using the specified context.
        /// </summary>
        /// <param name="context">
        ...
        /// <summary>Converts a string to a Gender, using the specified
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            ...
            {
                return Gender.Parse(str, culture);
            }
        ...
        /// <summary>Converts a Gender to string, using the specified context and culture information.</summary>
        /// <param name="culture">
        ...
        /// </param>
        /// <param name="value">
        /// The Gender to convert.
        /// </param>
        /// <param name="destinationType">
        /// The System.Type to convert the value parameter to.
        /// </param>
        /// <returns>
        /// A string that represents the converted Gender.
        /// </returns>
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            ...
            {
                return ((Gender)value).ToString(culture);
            }
