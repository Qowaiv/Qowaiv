...
namespace Qowaiv.Conversion
{
    ...
    public class PercentageTypeConverter : TypeConverter
    {
        ...
        /// a Percentage, using the specified context.
        /// </summary>
        /// <param name="context">
        ...
        /// <summary>Converts a Percentage to string, using the specified context and culture information.</summary>
        /// <param name="culture">
        ...
        /// </param>
        /// <returns>
        /// A string that represents the converted Percentage.
        /// </returns>
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            ...
            {
                return ((Percentage)value).ToString(culture);
            }
