...
namespace Qowaiv.Conversion.Security.Cryptography
{
    ...
    public class CryptographicSeedTypeConverter : TypeConverter
    {
        ...
        /// a cryptographic seed, using the specified context.
        /// </summary>
        /// <param name="context">
        ...
        /// <summary>Converts a cryptographic seed to string, using the specified context and culture information.</summary>
        /// <param name="culture">
        ...
        /// </param>
        /// <param name="value">
        /// The cryptographic seed to convert.
        /// </param>
        /// <param name="destinationType">
        /// The System.Type to convert the value parameter to.
        /// </param>
        /// <returns>
        /// A string that represents the converted cryptographic seed.
        /// </returns>
