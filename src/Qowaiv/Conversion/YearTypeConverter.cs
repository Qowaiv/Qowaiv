...
namespace Qowaiv.Conversion
{
    ...
    public class YearTypeConverter : TypeConverter
    {
        ...
        /// a year, using the specified context.
        /// </summary>
        /// <param name="context">
        ...
        /// <summary>Converts a string to a year, using the specified
        ...
        /// <summary>Converts a year to string, using the specified context and culture information.</summary>
        /// <param name="culture">
        ...
        /// </param>
        /// <returns>
        /// A string that represents the converted year.
        /// </returns>
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            ...
            {
                return ((Year)value).ToString(culture);
            }
