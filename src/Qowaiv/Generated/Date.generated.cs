...
namespace Qowaiv
{
    ...
    public partial struct Date : IJsonSerializable
    {
        /// <inheritdoc/>
...
namespace Qowaiv
{
    ...
    public partial struct Date
    {
        ...
        {
            return TryParse(s, formatProvider, out Date val) ? val : throw new FormatException(QowaivMessages.FormatExceptionDate);
        }
        ...
        {
            return TryParse(s, CultureInfo.CurrentCulture, out Date val) ? val : default;
        }
        ...
        /// </returns>
        public static bool TryParse(string s, out Date result) => TryParse(s, CultureInfo.CurrentCulture, out result);
#else
        /// <summary>Converts the <see cref="string"/> to <see cref="Date"/>.</summary>
        /// <param name="s">
        /// A string containing the date to convert.
        ...
        {
            return TryParse(s, out Date val)
                ? val
        ...
        public static Date TryParse(string s)
        {
            return TryParse(s, out Date val) ? val : default;
        }
#endif
    }
}
