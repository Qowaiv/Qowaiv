...
namespace Qowaiv
{
    ...
    public partial struct EmailAddress : IJsonSerializable
    {
        /// <inheritdoc/>
...
namespace Qowaiv
{
    ...
    public partial struct EmailAddress
    {
        ...
        {
            return TryParse(s, formatProvider, out EmailAddress val) ? val : throw new FormatException(QowaivMessages.FormatExceptionEmailAddress);
        }
        ...
        {
            return TryParse(s, CultureInfo.CurrentCulture, out EmailAddress val) ? val : default;
        }
        ...
        {
            return TryParse(s, out EmailAddress val)
                ? val
        ...
        public static EmailAddress TryParse(string s)
        {
            return TryParse(s, out EmailAddress val) ? val : default;
        }
#endif
    }
}
