...
namespace Qowaiv.Financial
{
    ...
    public partial struct BusinessIdentifierCode : IComparable, IComparable<BusinessIdentifierCode>
    {
        ...
        {
            if (obj is BusinessIdentifierCode other)
            {
...
namespace Qowaiv.Financial
{
    ...
    public partial struct BusinessIdentifierCode : IJsonSerializable
    {
        /// <inheritdoc/>
...
namespace Qowaiv.Financial
{
    ...
    public partial struct BusinessIdentifierCode
    {
        ...
        {
            return TryParse(s, formatProvider, out BusinessIdentifierCode val) ? val : throw new FormatException(QowaivMessages.FormatExceptionBusinessIdentifierCode);
        }
        ...
        {
            return TryParse(s, CultureInfo.CurrentCulture, out BusinessIdentifierCode val) ? val : default;
        }
        ...
        /// </returns>
        public static bool TryParse(string s, out BusinessIdentifierCode result) => TryParse(s, CultureInfo.CurrentCulture, out result);
#else
        /// <summary>Converts the <see cref="string"/> to <see cref="BusinessIdentifierCode"/>.</summary>
        /// <param name="s">
        /// A string containing the BIC to convert.
        ...
        {
            return TryParse(s, out BusinessIdentifierCode val)
                ? val
        ...
        public static BusinessIdentifierCode TryParse(string s)
        {
            return TryParse(s, out BusinessIdentifierCode val) ? val : default;
        }
#endif
    }
}
