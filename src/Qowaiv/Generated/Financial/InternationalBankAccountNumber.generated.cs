...
#endif
{
    ...
    /// </exception>
    [Pure]
    public static InternationalBankAccountNumber Parse(string? s, IFormatProvider? provider) => TryParse(s, provider) ?? throw new FormatException(QowaivMessages.FormatExceptionInternationalBankAccountNumber);
