...
#endif
{
    ...
    /// </exception>
    [Pure]
    public static HouseNumber Parse(string? s, IFormatProvider? provider) => TryParse(s, provider) ?? throw new FormatException(QowaivMessages.FormatExceptionHouseNumber);
