...
namespace Qowaiv.Identifiers
{
    ...
    public partial struct Id<TIdentifier>
    {
#if !NotField
        private Id(System.Object value) =>  m_Value =  value ; 
...
#endif
#if !NotIsUnknown
        /// <summary>Returns true if the  identifier is unknown, otherwise false.</summary>
        public bool IsUnknown() => m_Value == Unknown.m_Value;
#endif
#if !NotIsEmptyOrUnknown
        /// <summary>Returns true if the  identifier is empty or unknown, otherwise false.</summary>
...
namespace Qowaiv.Identifiers
{
    ...
    public partial struct Id<TIdentifier> : IEquatable<Id<TIdentifier>>
    {
        /// <inheritdoc/>
        ...
        /// <param name = "other">The <see cref = "Id<TIdentifier>" /> to compare with.</param>
        public bool Equals(Id<TIdentifier> other) => m_Value == other.m_Value;
...
namespace Qowaiv.Identifiers
{
    ...
    public partial struct Id<TIdentifier> : IComparable, IComparable<Id<TIdentifier>>
    {
        /// <inheritdoc/>
...
#if !NotEqualsSvo
        /// <inheritdoc/>
        public int CompareTo(Id<TIdentifier> other) => Comparer<System.Object>.Default.Compare(m_Value, other.m_Value);
#endif
#if !NoComparisonOperators
        /// <summary>Returns true if the left operator is less then the right operator, otherwise false.</summary>
        public static bool operator <(Id<TIdentifier> l, Id<TIdentifier> r) => l.CompareTo(r) < 0;
...
namespace Qowaiv.Identifiers
{
    ...
    public partial struct Id<TIdentifier> : ISerializable
    {
        ...
        Guard.NotNull(info, nameof(info) ) ; m_Value =  (System.Object) info.GetValue( "Value",  typeof  (System.Object));
    }
...
namespace Qowaiv.Identifiers
{
    ...
    public partial struct Id<TIdentifier> : IXmlSerializable
    {
        ...
        partial void OnReadXml(Id<TIdentifier> other);
...
#if !NotCultureDependent
        public static Id<TIdentifier> FromJson(string json) => Parse(json, CultureInfo.InvariantCulture);
#else
...
namespace Qowaiv.Identifiers
{
    ...
    public partial struct Id<TIdentifier> : IFormattable
    {
...
namespace Qowaiv.Identifiers
{
    ...
    public partial struct Id<TIdentifier>
    {
        ...
        /// </exception>
        public static Id<TIdentifier> Parse(string s) => Parse(s, CultureInfo.CurrentCulture);
        /// <summary>Converts the <see cref = "string "/> to <see cref = "Id<TIdentifier>"/>.</summary>
        /// <param name = "s">
        /// A string containing the identifier to convert.
        /// </param>
        ...
        /// <paramref name = "s"/> is not in the correct format.
        /// </exception>
        public static Id<TIdentifier> Parse(string s, IFormatProvider formatProvider)
        {
            return TryParse(s, formatProvider, out Id<TIdentifier> val) ? val : throw new FormatException();
        }
        ...
        {
            return TryParse(s, CultureInfo.CurrentCulture, out Id<TIdentifier> val) ? val : default;
        }
        ...
        /// </returns>
        public static bool TryParse(string s, out Id<TIdentifier> result) => TryParse(s, CultureInfo.CurrentCulture, out result);
#else
        /// <summary>Converts the <see cref="string"/> to <see cref="Id<TIdentifier>"/>.</summary>
        /// <param name="s">
        /// A string containing the identifier to convert.
