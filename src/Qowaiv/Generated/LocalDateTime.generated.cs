...
namespace Qowaiv
{
    ...
    public partial struct LocalDateTime : IJsonSerializable
    {
        /// <inheritdoc/>
...
namespace Qowaiv
{
    ...
    public partial struct LocalDateTime
    {
        ...
        {
            return TryParse(s, formatProvider, out LocalDateTime val) ? val : throw new FormatException(QowaivMessages.FormatExceptionLocalDateTime);
        }
        ...
        {
            return TryParse(s, CultureInfo.CurrentCulture, out LocalDateTime val) ? val : default;
        }
        ...
        /// </returns>
        public static bool TryParse(string s, out LocalDateTime result) => TryParse(s, CultureInfo.CurrentCulture, out result);
#else
        /// <summary>Converts the <see cref="string"/> to <see cref="LocalDateTime"/>.</summary>
        /// <param name="s">
        /// A string containing the local date time to convert.
        ...
        {
            return TryParse(s, out LocalDateTime val)
                ? val
        ...
        public static LocalDateTime TryParse(string s)
        {
            return TryParse(s, out LocalDateTime val) ? val : default;
        }
#endif
    }
}
