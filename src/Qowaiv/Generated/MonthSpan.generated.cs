...
namespace Qowaiv
{
    ...
    public partial struct MonthSpan : IConvertible
    {
        /// <inheritdoc/>
...
namespace Qowaiv
{
    ...
    public partial struct MonthSpan
    {
        ...
        {
            return TryParse(s, formatProvider, out MonthSpan val) ? val : throw new FormatException(QowaivMessages.FormatExceptionMonthSpan);
        }
        ...
        {
            return TryParse(s, CultureInfo.CurrentCulture, out MonthSpan val) ? val : default;
        }
        ...
        /// </returns>
        public static bool TryParse(string s, out MonthSpan result) => TryParse(s, CultureInfo.CurrentCulture, out result);
#else
        /// <summary>Converts the <see cref="string"/> to <see cref="MonthSpan"/>.</summary>
        /// <param name="s">
        /// A string containing the month span to convert.
        ...
        {
            return TryParse(s, out MonthSpan val)
                ? val
        ...
        public static MonthSpan TryParse(string s)
        {
            return TryParse(s, out MonthSpan val) ? val : default;
        }
#endif
    }
}
