...
namespace Qowaiv
{
    ...
    public partial struct PostalCode : IJsonSerializable
    {
        /// <inheritdoc/>
...
namespace Qowaiv
{
    ...
    public partial struct PostalCode
    {
        ...
        {
            return TryParse(s, formatProvider, out PostalCode val) ? val : throw new FormatException(QowaivMessages.FormatExceptionPostalCode);
        }
        ...
        {
            return TryParse(s, CultureInfo.CurrentCulture, out PostalCode val) ? val : default;
        }
        ...
        /// </returns>
        public static bool TryParse(string s, out PostalCode result) => TryParse(s, CultureInfo.CurrentCulture, out result);
#else
        /// <summary>Converts the <see cref="string"/> to <see cref="PostalCode"/>.</summary>
        /// <param name="s">
        /// A string containing the postal code to convert.
        ...
        {
            return TryParse(s, out PostalCode val)
                ? val
        ...
        public static PostalCode TryParse(string s)
        {
            return TryParse(s, out PostalCode val) ? val : default;
        }
#endif
    }
}
