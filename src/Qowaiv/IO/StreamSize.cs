...
namespace Qowaiv.IO
{
	...
	public struct StreamSize : ISerializable, IXmlSerializable, IJsonSerializable, IFormattable, IComparable, IComparable<StreamSize>
	{
		...
		public static readonly StreamSize Zero = new StreamSize() { m_Value = 0L };
		...
		public static readonly StreamSize MaxValue = new StreamSize() { m_Value = Int64.MaxValue };

		/// <summary>Initializes a new instance of a stream size.</summary>
		/// <param name="size">
		/// The number of bytes.
		/// </param>
		public StreamSize(Int64 size)
		{
			m_Value = size;
		}
		...
		/// </returns>
		public int CompareTo(StreamSize other) { return m_Value.CompareTo(other.m_Value); }


		/// <summary>Returns true if the left operator is less then the right operator, otherwise false.</summary>
		public static bool operator <(StreamSize l, StreamSize r) { return l.CompareTo(r) < 0; }
		...
		public static explicit operator Double(StreamSize val) { return (Double)val.m_Value; }
