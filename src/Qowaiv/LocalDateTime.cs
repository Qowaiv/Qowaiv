...
namespace Qowaiv
{
    ...
    [OpenApiDataType(description: "Date-time notation as defined by RFC 3339, without time zone information, for example, 2017-06-10 15:00.", type: "string", format: "date-time-local")]
