...
namespace Qowaiv {
    ...
    public class QowaivMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Argument is the not initialized/default value..
        /// </summary>
        public static string ArgumentException_IsDefaultValue {
            get {
                return ResourceManager.GetString("ArgumentException_IsDefaultValue", resourceCulture);
            }
        }
