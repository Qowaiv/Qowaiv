...
namespace Qowaiv
{
    ...
    public partial struct Uuid : ISerializable, IXmlSerializable, IFormattable, IEquatable<Uuid>, IComparable, IComparable<Uuid>
    {
        ...
        /// of UUID's are identical.
        /// </remarks>
        public static Uuid NewSequential(UuidComparer comparer) => NewSequential(comparer, false);
        ...
        /// <remarks>
        /// * The first 7 bytes are based on ticks from <see cref="Clock.UtcNow()"/>.
        /// * The UUID's generated are sequential between 1970-01-01 and  9306-12-04.
        /// * Withing a timespan of 32 ticks (0.32 nanoseconds) there is a 25% change
        ///   that UUID's are not sequential.
        /// * For preffilled UUID's the timespan is 8192 ticks (81.92 nanoseconds).
        /// </remarks>
        public static Uuid NewSequential(UuidComparer comparer, bool prefilled)
        {
            return UuidGenerator.Sequential(comparer, prefilled);
        }
