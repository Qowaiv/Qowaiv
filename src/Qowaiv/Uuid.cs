...
namespace Qowaiv
{
    ...
    public partial struct Uuid : ISerializable, IXmlSerializable, IFormattable, IEquatable<Uuid>, IComparable, IComparable<Uuid>
    {
        ...
        /// </remarks>
        public static Uuid NewSequential() => NewSequential(UuidComparer.Default, false);
        ...
        {
            var c = comparer ?? UuidComparer.Default;
            var sequential = (Clock.UtcNow().Ticks - TicksYear2000) >> 5;
            var start = 0;
