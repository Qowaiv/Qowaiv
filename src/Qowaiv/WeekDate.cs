...
namespace Qowaiv
{
	...
	public struct WeekDate : ISerializable, IXmlSerializable, IJsonSerializable, IFormattable, IComparable, IComparable<WeekDate>
	{
		...
		/// <summary>Gets the xml schema to (de) xml serialize a week date.</summary>
		/// <remarks>
		/// Returns null as no schema is required.
		/// </remarks>
		XmlSchema IXmlSerializable.GetSchema() { return null; }

		/// <summary>Reads the week date from an xml writer.</summary>
		/// <remarks>
		...
		/// <summary>Writes the week date to an xml writer.</summary>
		/// <remarks>
