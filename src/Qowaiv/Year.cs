...
namespace Qowaiv
{
	...
	public struct Year : ISerializable, IXmlSerializable, IJsonSerializable, IFormattable, IComparable, IComparable<Year>
	{
		...
		public static readonly Year Empty = new Year() { m_Value = default(Int16) };
		...
		/// <summary>Gets the xml schema to (de) xml serialize a year.</summary>
		/// <remarks>
		/// Returns null as no schema is required.
		/// </remarks>
		XmlSchema IXmlSerializable.GetSchema() { return null; }

		/// <summary>Reads the year from an xml writer.</summary>
		/// <remarks>
		...
		/// <summary>Writes the year to an xml writer.</summary>
		/// <remarks>
