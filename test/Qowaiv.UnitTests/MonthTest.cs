...
namespace Qowaiv.UnitTests
{
    ...
    public class MonthTest
    {
        ...
        public void Constructor_SerializationInfoIsNull_ThrowsArgumentNullException()
        {
            ...
            (() =>
            {
                SerializationTest.DeserializeUsingConstructor<Month>(null, default);
            },
            "info");
        }
        ...
        public void Constructor_InvalidSerializationInfo_ThrowsSerializationException()
        {
            ...
            (() =>
            {
                ...
                SerializationTest.DeserializeUsingConstructor<Month>(info, default);
            });
        }
        ...
        {
            var act = JsonTester.Read<Month>(2L);
            var exp = TestStruct;
        ...
        {
            var act = TestStruct.ToString("m", new UnitTestFormatProvider());
            var exp = "Unit Test Formatter, value: '02', format: 'm'";
        ...
        {
            var act = TestStruct.GetFullName(new CultureInfo("es-ES"));
            var exp = "febrero";
            Assert.AreEqual(exp, act);
        }
        ...
        {
            var act = TestStruct.GetShortName(new CultureInfo("es-ES"));
            var exp = "feb.";
            Assert.AreEqual(exp, act);
        }
