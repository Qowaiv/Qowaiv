...
namespace Postal_code_per_country_specs
{
    public class Is
    {
        [TestCaseSource(nameof(ValidPostalCodes))]
        public void valid_for(Country country, PostalCode postalCode)
        {
            Assert.IsTrue(postalCode.IsValid(country));
        }

        [TestCaseSource(nameof(InvalidPostalCodes))]
        public void not_valid_for(Country country, PostalCode postalCode)
        {
            Assert.IsFalse(postalCode.IsValid(country));
        }

        private static readonly IEnumerable<object[]> ValidPostalCodes = new []
        {
        ...
        private static readonly IEnumerable<object[]> InvalidPostalCodes = new []
        {
            new PostalCodes(Country.AD, "12", "1234", "AD890"),
            new PostalCodes(Country.AF, "123", "12345"),
            new PostalCodes(Country.AI, "123", "12345"),
            new PostalCodes(Country.AM, "123", "12345"),
            new PostalCodes(Country.AR, "1234567", "123456789"),
            new PostalCodes(Country.AS, "1234", "123456", "1234567", "12345678"),
            new PostalCodes(Country.AT, "123", "12345"),
            new PostalCodes(Country.AU, "123", "12345"),
            new PostalCodes(Country.AX, "1234", "123456"),
            new PostalCodes(Country.AZ, "123", "12345"),
            new PostalCodes(Country.BA, "1234", "123456"),
            new PostalCodes(Country.BB, "1234", "123456"),
            new PostalCodes(Country.BD, "123", "12345"),
            new PostalCodes(Country.BE, "123", "12345"),
            new PostalCodes(Country.BG, "123", "12345"),
            new PostalCodes(Country.BH, "12", "12345"),
            new PostalCodes(Country.BL, "1234", "123456"),
            new PostalCodes(Country.BM, "1", "123", "12345"),
            new PostalCodes(Country.BN, "12345", "1234567"),
        }
        .SelectMany(codes => codes.ToArrays());
    }
