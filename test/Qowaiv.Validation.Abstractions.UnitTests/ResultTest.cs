...
namespace Qowaiv.Validation.Abstractions.UnitTests
{
    public class ResultTest
    {
        ...
        internal static readonly ValidationMessage Warning1 = ValidationMessage.Warn("Warning 1");
        internal static readonly ValidationMessage Warning2 = ValidationMessage.Warn("Warning 2");
        ...
        {
            var actual = Result.WithMessages(ValidationMessage.Warn("This should valid"));
